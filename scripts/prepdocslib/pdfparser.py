...
class PdfParser(ABC):
    ...
    async def parseURL(self, file_url: str) -> AsyncGenerator[Page, None]:
        if False:
           yield
...
class DocumentAnalysisPdfParser(PdfParser):
    ...
    def __init__(
        ...
        #self.formurl = "https://teststo1232.blob.core.windows.net/public/纺织_11775159.pdf"
        #self.formurl = "https://teststo1232.blob.core.windows.net/public/纺织面料_12086455.pdf"
        #self.formurl = "https://teststo1232.blob.core.windows.net/public/纺织面料_13388707.pdf"    
        #self.formurl = "https://teststo1232.blob.core.windows.net/public/纺织天地_13575950.pdf"   
        #self.formurl = "https://teststo1232.blob.core.windows.net/public/服装面料学_14640176.pdf" 
        # self.formurl = "https://teststo1232.blob.core.windows.net/public/棉纺手册%20%20第3版_11344442.pdf"
        #self.formurl = "https://teststo1232.blob.core.windows.net/public/新型纺纱_10946992.pdf"


    async def parseURL(self, file_url: str) -> AsyncGenerator[Page, None]:
        if self.verbose:
            print(f"Extracting text from '{file_url}' using Azure Document Intelligence")
        ...
        async with DocumentAnalysisClient(
            ...
            poller = await form_recognizer_client.begin_analyze_document_from_url(model_id=self.model_id, document_url=file_url, locale="zh-Hans") 
            form_recognizer_results = await poller.result()
            print(form_recognizer_results.pages.count)
            offset = 0
