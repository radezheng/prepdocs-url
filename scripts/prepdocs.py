...
def setup_file_strategy(credential: AsyncTokenCredential, args: Any) -> FileStrategy:
    ...
    print(f"Processing files...{args.isremote}")
    list_file_strategy: ListFileStrategy
    if args.isremote:
        print(f"Using remote files in {args.files}")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--isremote",
        required=False,
        help="using existing remote files in Azure Blob Storage container instead of local files",
    )
